  ...
  return (
    <div
      className={twMerge(
        ...
        'dark:prose-pre:bg-polar-800 dark:prose-pre:border-polar-700 prose-pre:border prose-pre:border-transparent prose-pre:bg-gray-100 prose-pre:rounded-2xl prose-pre:text-gray-600 dark:prose-pre:text-polar-200',
        'prose-code:before:content-none prose-code:after:content-none prose-code:bg-gray-100 dark:prose-code:bg-polar-800 prose-code:font-normal prose-code:rounded-sm prose-code:px-1.5 prose-code:py-1'
      )}
    >
      {children}
    </div>
